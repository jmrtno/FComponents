//
//  FCButtonAlternativeGallery.swift
//  FComponents
//
...
struct FCButtonAlternativeGallery: View {
    var body: some View {
        VStack(alignment: .leading) {
            ...
            VStack(alignment: .leading)  {
                ...
                HStack {
                    FCButton(createButtonSizedViewModel(label: "Button",
                                                        size: .large, invertCorners: true))
                    FCButton(createButtonSizedViewModel(label: "Button",
                                                        size: .medium,
                                                        invertCorners: true))
                    FCButton(createButtonSizedViewModel(label: "Button",
            ...
            VStack(alignment: .leading)  {
                ...
                HStack {
                    FCButton(createButtonIconSizedViewModel(label: "B",
                                                            size: .large,
                                                            invertCorners: true))
                    FCButton(createButtonIconSizedViewModel(label: "Btn",
                                                            size: .medium,
                                                            invertCorners: true))
                    FCButton(createButtonIconSizedViewModel(label: "Button",
                                                            size: .small,
                                                            invertCorners: true))
                }
            }
    ...
    private func createButtonViewModel(label: String? = nil,
        ...
        let variant = FCButton.Variant(type: .alternative(color: color))
